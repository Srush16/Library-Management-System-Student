...
<div style="color:white; margin-left: 30px;"> 
                 ...
                 {
                 echo "<img class='image-circle profile_img'=src='images/".$_SESSION['pic']."'>";
...
function closeNav() {
  ...
  document.body.style.backgroundColor="white";
	...
	<!--___________________search bar___________________________-->
